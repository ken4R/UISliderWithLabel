...
SWIFT_MODULE_NAMESPACE_PUSH("CustomSlider")
@class UIWindow;
@class UIApplication;

SWIFT_CLASS("_TtC12CustomSlider11AppDelegate")
...
SWIFT_CLASS("_TtC12CustomSlider12CustomSlider")
...
SWIFT_CLASS("_TtC12CustomSlider16SliderThumbLayer")
@interface SliderThumbLayer : CALayer
/// draw the thumb
...
SWIFT_CLASS("_TtC12CustomSlider16SliderTrackLayer")
...
SWIFT_CLASS("_TtC12CustomSlider10SliderView")
...
/// \param rangeSlider the changed rangeSlider
///
- (void)rangeSliderValueChanged:(CustomSlider * _Nonnull)rangeSlider;
/// layout subviews
- (void)layoutSubviews;
